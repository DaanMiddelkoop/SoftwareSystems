...
public class ClientHandler extends Thread { 
    ...
    private void listRecipes(Writer out) throws IOException { 
     File[] files = new File("C:/Users/rlubbers/workspace/Softwaresystemen/ss/week7/recipeserver/recipes").listFiles(); 
     for (File file : files) { 
   out.write(file.getName() + System.lineSeparator()); 
    ...
    private void showRecipe(String recipeName, Writer out) throws IOException { 
     String recipeFilename = "C:/Users/rlubbers/workspace/Softwaresystemen/ss/week7/recipeserver/recipes" + File.separator + recipeName; 
