...
public class Card implements Serializable
{
    ...
    */
	...
	public static void main(String[] args) {
		...
		new Card('C', '2').write(printer);
		new Card('D', '3').write(printer);
		new Card('H', '4').write(printer);
		new Card('S', '5').write(printer);
		new Card('C', '6').write(printer);
		new Card('D', '7').write(printer);
		new Card('H', '8').write(printer);
	}
	...
	public static Card read(BufferedReader in) throws EOFException {
		...
		return new Card(strings[0].charAt(0), strings[1].charAt(0));
	}
